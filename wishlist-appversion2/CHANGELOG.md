...
🌟 **쉬운 설명**
- 쇼핑몰마다 상품 페이지를 새로 열어 이름·가격·사진을 정답으로 적고, 탭에서 엔진이 같은 값을 읽는지 비교했습니다. 38몰은 정답이 채워졌고, 나머지 12몰은 페이지가 앱처럼 열려서 아직 못 채웠습니다.

🔧 **기술 설명**
- `integration_test/live_field_compare_catalog.dart`를 2026-08-18 신규 상품으로 교체. 판매가는 화면 판매가(첫구매·카드 쿠폰 제외).
- 정답 3개: 카페24 계열 대부분, 무신사, 29CM, W컨셉, FILA, 하고, 탑텐, KREAM, 나이키, 지그재그 등 37몰(+낫포유 2개).
- 아직 없음: 룩핀, 롯데온, 유니클로, 에이블리, 반스, 코드그라피, Aritzia, 올리브영, 퀸잇, 브랜디, SSF샵, 이랜드몰.
- 탭 S7 신규 정답 대조: MATCH 무신사·29CM·게스·후아유·예일·FILA·아모멘토·앤더슨벨 각 3, 커버낫·데일리쥬 2, 미쏘·나이키 1.
- 이름·사진 맞고 가격만 낮거나 `price_ambiguous`: 리, 필루미네이트, 어반스터프, 파브레가, 인사일런스, 립합, 마하그리드, 비바스튜디오, KREAM.
- 하고는 이름·가격 맞고 사진 파일명만 다름(`1.jpg` vs `view_1.jpg`). 핫핑은 엔진 이름에 HTML 태그. 낫포유 290 hang.
- 앱 uninstall 없음.
