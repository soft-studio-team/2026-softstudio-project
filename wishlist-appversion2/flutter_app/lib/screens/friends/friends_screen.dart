...
class _SalkamalkaFeedPane extends StatelessWidget {
            ...
            children: [
              Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () => _hideFromFeed(context, e),
                    tooltip: '목록에서 숨기기',
  ...
  Future<void> _hideFromFeed(
      BuildContext context, SalkamalkaFeedEntry e) {
    return context.read<AppStore>().hideFromSalkamalkaFeed(e.basket.id);
  }
