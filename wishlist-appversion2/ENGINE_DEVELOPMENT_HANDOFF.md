...
다음: §0.13 패치 우선순위. **1~3차** 완료(W컨셉·핫핑·Cafe24·노이아고·위드윤). **이미지:** 하고·룩핀 MATCH 3, 패션플러스 MATCH 3(카탈로그 교체+og 거부). 남음: 에이블리 로드, 앤더슨벨#2 리다이렉트, SSG deal→단품 카탈로그, 더현대Hi·4910 live 가격, 회원가(~90%) 몰.
